...
export const ko: Translation = {
	...
	[Key.moviesGamesSubtitle]: "影视、音乐与游戏记录",
	...
	[Key.musicGenreHipHopRap]: "嘻哈说唱",
	[Key.musicGenreRnBSoul]: "R&B 灵魂",
	[Key.musicGenreIndieAlt]: "独立另类",
	[Key.musicGenreLatinWorld]: "拉丁世界音乐",
	[Key.musicGenreSoundtrack]: "原声带",
	// 游戏页面
	[Key.games]: "游戏",
	[Key.gamesTitle]: "游戏库",
	[Key.gamesSubtitle]: "按平台记录的游戏",
	[Key.gamesTabAll]: "全部",
	[Key.gamesPlaytime]: "游玩时长",
	[Key.gamesLastPlayed]: "最近游玩",
	[Key.gamesAchievements]: "成就",
	[Key.gamesStoreLink]: "商店链接",
	[Key.gamesNoData]: "暂无游戏",
	// 更新日志
	[Key.changelog]: "更新日志",
	[Key.changelogTitle]: "更新日志",
	[Key.changelogSubtitle]: "版本记录",
	[Key.changelogAll]: "全部",
	[Key.changelogFeature]: "新增",
	[Key.changelogImprovement]: "优化",
	[Key.changelogFix]: "修复",
	[Key.changelogRemoval]: "移除",
	[Key.changelogNoData]: "暂无更新",
	// 动态
	[Key.moments]: "动态",
	[Key.recentMoments]: "最新动态",
	[Key.recentLife]: "生活记录",
	[Key.recentItems]: "最新条目",
};
